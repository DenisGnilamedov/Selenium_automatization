...
# pytest -rx -s -v test_3_5_step5_mark_xfail.py

# pytest -rX -s -v test_3_5_step5_mark_xfail.py - Здесь мы добавили символ X в параметр -r, чтобы получить подробную информацию по XPASS-тестам